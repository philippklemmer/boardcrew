...
<html>
    ...
    <body>
        ...
        <?php if($_GET['url'] === "index" || !isset($_GET['url']) ): ?>
          ...
          <?php elseif($_GET['url'] === "timeline" || $_GET['url'] === "userprofile" || $_GET['url'] === "userbackend" ): ?>
        ...
        <?php if($_GET['url'] === "timeline" || $_GET['url'] === "userprofile" || $_GET['url'] === "userbackend"): ?>
        ...
        <!--FILTERMETHOD-->
        <div class="generalFilterContainer showHide">
